...
This step restricts calculations linked with the detection function (here a halfnormal function) to detectors within a maximum radius within which detections are realistically possible [@Milleret2019]. 

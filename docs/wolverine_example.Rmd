...
The function `dbinomLocal_normal()` takes the `logical` argument `indicator` that specifies whether the individual `i` is available ($z_i$ = 1) for detection or not ($z_i$ = 0). When $z_i$ = 0, calculations of $p_i$ are not performed and therefore increases MCMC efficiency.   

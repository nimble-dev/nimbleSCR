...
Last, we re-express the detection matrix `y` as a sparse matrix, to reduce its size. In this representation, we turn the detection matrix `y` into three objects:

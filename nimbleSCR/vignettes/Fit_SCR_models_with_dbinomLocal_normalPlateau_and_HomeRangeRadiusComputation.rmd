...
vignette: >
  %\VignetteIndexEntry{Home range size estimation with the nimbleSCR package}
...
\end{align}
where $p_{0} \in (0,1)$, $\text{rate} > 0$. Here $p_0$ denotes the baseline detection probability and $\sigma$ denotes the rate parameter. For a better understanding, we also plot the detection function against distance.
```{r , warning = FALSE, message = FALSE, fig.width = 6, fig.height = 4}
